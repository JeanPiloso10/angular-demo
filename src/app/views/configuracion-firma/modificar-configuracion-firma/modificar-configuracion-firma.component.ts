...
@Component({
  selector: 'app-modificar-configuracion-firma',
  templateUrl: './modificar-configuracion-firma.component.html',
  styleUrl: './modificar-configuracion-firma.component.scss',
  standalone:false
})
export class ModificarConfiguracionFirmaComponent {
  ...
  private loadModelo(): void {
    ...
    this.configuracionFirmaService.consultaId(this.id)
      .subscribe({
        next: (respuesta) => {
  ...
  guardarCambios(data: any) {
    this.spinnerService.showGlobalSpinner();
    this.configuracionFirmaService.editar(this.modelo.idConfiguracionFirma,data).pipe(
