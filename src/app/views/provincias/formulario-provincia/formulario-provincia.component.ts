...
private patchFormValues() {
  if (this.StateEnum === TipoAccion.Create && this.modelo && this.modelo.codigoPais) {
    this.form.patchValue({ codigoPais: this.modelo.codigoPais });
  }
    ...
    this.form.patchValue(
      {    
        ...
        codigoPais: this.modelo.codigoPais, 
